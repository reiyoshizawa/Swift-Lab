...
var moviesDict:Dictionary = [ "Star Wars":"George Lucas", "Point Break":"Kathryn Bigelow", "Titanic":"James Cameron"]
var movie = "Point Break"
var director = moviesDict[movie]
if let director: Any? = director {
    director!
}
//: 1b) Test your code by inserting different values for the variable `movie`.
var movie2 = "Titanic"
var director2 = moviesDict[movie2]
if let director: Any? = director2 {
    director!
}
//: ### Exercise 2
...
if let number: Any? = Int(numericalString) {
