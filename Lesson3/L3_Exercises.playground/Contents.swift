...
let array = [true, true, false, false, false]
...
var removedLyla = waitingList.remove(at: 0)
var removedDaniel = waitingList.remove(at: 0)
waitingList.append(removedLyla)
waitingList.append(removedDaniel)
...
let foodDictionary = ["Anchovies": true, "Coconut": true, "Cilantro": false, "Liver": false]
...
if let obamasDog = presidentialDogs["Barack Obama"] {
    print("Michele Obama walks \(obamasDog) every morning.")
} else {
